...
const generateIdea = function(){
    let idea1 = Math.floor((Math.random()*thisArray.length)); 
    console.log(idea1);
    let idea2 = Math.floor((Math.random()*thatArray.length)); 
    console.log(idea2);

    return `Your startup idea of the day: ${thisArray[idea1]} and ${thatArray[idea2]}`;
}
